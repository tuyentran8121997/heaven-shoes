...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb">
      ...
      <a href="#">Trang CMS</a>
      <a href="#" class="current">Chỉnh sửa trang CMS</a>
  </div>
    <h1>Trang CMS</h1>
      ...
      <div class="span12">
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-info-sign"></i> </span>
            <h5>Chỉnh sửa trang CMS</h5>
          </div>
          <div class="widget-content nopadding">
            <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url('/admin/edit-cms-page/'.$cmsPage->id) }}" name="edit_cms_page" id="edit_cms_page" novalidate="novalidate">@csrf
